        ...
        <div class="p-0">
            ...
            <div class="grid grid-cols-1 gap-1 my-2 ">
                <div
                    ...
                    <div
                        class="-mx-2 sm:-mx-4 sm:px-0 p-0 overflow-x-auto min-h-screen w-full rounded-md border-2 border-primary dark:border-primary-light bg-gray-50 dark:bg-darker">
                        ...
                        <table class="table md:table-sm sm:table-sm w-full lg:text-base md:text-base sm:text-xs ">
                            <thead>
                                                        ...
                                                        <div class="shadow rounded-lg flex">
                                                            <div class="relative">
                                                                ...
                                                                <div x-show="open" x-cloak @click.away="open = false"
                                                                    class="z-10 absolute top-0 right-0 w-60 bg-gray-50 border border-gray-200 dark:text-light dark:bg-darker dark:border-primary-darker rounded-lg shadow-lg mt-12 -mr-1 block py-1 overflow-auto h-96 shadow-2xl">
                                                                    <template x-for="heading in headings">
                                                                        <label
                                                                            class="flex justify-start items-center text-truncate hover:bg-primary-100 px-4 py-2">
                                                                            <div class="text-gray-600 mr-3">
                                                                                <div class="text-primary-lighter mr-3">
                                                                                    <input type="checkbox"
                                                                            ...
                                                                            <div class="select-none text-sm dark:text-light "
                                                                                x-text="heading.title"></div>
                                                                        </label>
                                                                    </template>
                                                                </div>
                                                            </div>
                                ...
                                <tr class="bg-primary-50">
                                    <th
                                        class="px-2 py-2 border-b-2 border-primary dark:border-primary-light text-left font-extralight tracking-tighter default-width">
                                        <span>{{ __('Photos') }}</span>
                                    </th>
                                    <template x-for="heading in headings" :key="heading.name">
                                        <th class="px-2 py-2 border-b-2 border-primary dark:border-primary-light text-left font-extralight tracking-tighter default-width"
                                            :x-ref="heading.name"
                                            :class="{
                                                [heading.name]: true
                                            }">
